...
int main() {
  ...
  char word[512];
  bool success = get_word("One, two, three!", 3, word);
  if (success)
  ...
  success = get_word("What fountain-haunting nymph, what dryad, sought", 6, word);
  if (success)
    cout << "Word number 4 in \"What fountain-haunting nymph, what dryad, sought\" is " << word << endl;
  else
    cout << "Word number 4 in \"What fountain-haunting nymph, what dryad, sought\" does not exist." << endl;
  ...
  cout << "The line \"What fountain-haunting nymph, what dryad, sought\" contains ";
  ...
  find_phonetic_ending("111", phonetics);
  cout << "111 has phonetic ending " << phonetics << endl;
